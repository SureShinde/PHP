...
var swfobject = function () {
    ...
    function H() {
        ...
        for (var q = 0; q < t; q++) {
            ...
            if (h.pv[0] > 0) {
                var r = C(u);
                if (r) {
                    N[q].width = r.getAttribute("width") ? r.getAttribute("width") : "0";N[q].height = r.getAttribute("height") ? r.getAttribute("height") : "0";
                    if (c(N[q].swfVersion)) {
    ...
    return {
        registerObject: function (u, q, t) {
            ...
            r.id = u;
            r.swfVersion = q;
            r.expressInstall = t ? t : false;N[N.length] = r;W(u, false)
        },
