...
require_once('OFC/Elements/Axis/OFC_Elements_Axis_Y_Label_Set.php');
...
class OFC_Elements_Axis_Y extends OFC_Elements_Axis
{
	...
	{
		$y_axis_labels = new OFC_Elements_Axis_Y_Label_Set();
		$y_axis_labels->set_labels( $a );

		$this->labels = $y_axis_labels;

		/*if( isset( $this->steps ) )
        {
			$y_axis_labels->set_steps( $this->steps );
        }*/
	}
}
